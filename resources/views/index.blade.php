...
<head>
    ...
    <link href="{{config('swagger-lume.paths.assets_public')}}/css/index.css" rel="stylesheet"/>
    <link href='{{config('swagger-lume.paths.assets_public')}}/css/standalone.css' rel='stylesheet'/>
    <link href='{{config('swagger-lume.paths.assets_public')}}/css/api-explorer.css' rel='stylesheet' type='text/css'/>
    ...
    <script src='{{config('swagger-lume.paths.assets_public')}}/lib/bootstrap.min.js' type='text/javascript'></script>
